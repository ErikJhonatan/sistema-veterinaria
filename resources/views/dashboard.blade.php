...
@section('title', 'Consultorio veterinario SOS | Escritorio')
...
<!--Script para actualizar el año almacenado en el localstorage cada vez que se recargue la página-->
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const currentYear = new Date().getFullYear();
        const yearLocalStorage = localStorage.getItem('anio-contable');
        if (yearLocalStorage === null) {
            localStorage.setItem('anio-contable', currentYear);
        }
    });
</script>
